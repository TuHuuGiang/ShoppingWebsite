...
function Profile(props) {
  ...
  let updateAvatar = async () => {
    ...
    const imageRef = await ref(storage, 'avatars/avatar');
  ...
  async function reAuthFunc(e) {
    e.preventDefault();
    let credential = EmailAuthProvider.credential(user.email, newPass);
    try {
  ...
  async function updatePaswordFunc(e) {
    e.preventDefault();
    try {
      ...
      <div className="content">
        <div className="profile">
          <div className="profile-left">
            ...
            <div className="info-phone">
              ...
              <input
                type="text"
                defaultValue={props.info.telephone}
            ...
            <div className="save-profile">
              <button className="button button-c-black" onClick={updateAvatar}>
                Lưu thay đổi
              </button>
            </div>
          </div>
        ...
        <div className={toggleC ? 'modal-container active-modal' : 'modal-container'}>
          <div className="modal">
            ...
            <div className="modal-button">
              <button className="edit" onClick={(e) => updatePaswordFunc(e)}>
                Cập nhập
              </button>
